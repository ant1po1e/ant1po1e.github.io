					...
					<ul className="space-y-3">
						<li className="flex justify-center">
							<Link
								...
								className="relative flex items-center justify-center mt-2 py-2 px-4 md:px-8 overflow-hidden font-semibold text-black transition-all duration-300 ease-in-out rounded-lg md:hover:bg-white md:hover:text-blue-400 md:hover:scale-110 group">
								Snap Calculator
