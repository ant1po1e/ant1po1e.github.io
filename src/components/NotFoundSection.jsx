                    ...
                    <div className="mx-auto text-center space-y-3">
                        ...
                        <div className="pt-4">
                            <Link
                                ...
                                className="inline-block px-6 py-2 bg-black text-white font-semibold rounded-lg shadow-md md:hover:bg-rose-400 md:hover:scale-110 focus:ring-2 focus:ring-rose-400 focus:outline-none transition duration-300">
                                Back to Home
                            </Link>
                        </div>
                    </div>
