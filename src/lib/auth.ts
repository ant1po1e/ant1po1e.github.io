...
/**
 * Minimal structural type covering both the mutable RequestCookies (in
 * Route Handlers/Server Actions) and the read-only ReadonlyRequestCookies
 * variants exposed by `next/headers` — avoids depending on Next's
 * internal type paths.
 */
